                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="page-header">
                            <h3 class="page-title">Danh sách người dùng trên hệ thống</h3>
                        </div>
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-sm-flex align-items-center mb-4">
                                            <h4 class="card-title mb-sm-0">Danh sách giáo viên</h4>
                                        </div>
                                            ...
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="font-weight-bold">Xem thông tin</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                        ...
                                        <div class="d-sm-flex align-items-center mb-4">
                                            <h4 class="card-title mb-sm-0">Danh sách sinh viên</h4>
                                        </div>
                                        <div class="table-responsive border rounded p-1">
                                            <table class="table">
                                                <thead>
